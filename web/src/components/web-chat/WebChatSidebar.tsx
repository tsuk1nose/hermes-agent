...
export function WebChatSidebar({
  ...
  if (collapsed) {
    return (
      <div className={cn("flex h-full min-h-0 w-14 shrink-0 flex-col items-center gap-3 overflow-hidden border-r border-border/60 bg-muted/20 py-3", className)}>
        <Button
          ghost
          size="sm"
  ...
  return (
    <div className={cn("flex h-full min-h-0 w-64 shrink-0 flex-col overflow-hidden border-r border-border/60 bg-card/40", className)}>
